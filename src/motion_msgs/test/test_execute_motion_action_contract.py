"""ExecuteMotion Action 冻结字段与安全语义合同。"""
...
ACTION_PATH = PACKAGE_ROOT / 'action' / 'ExecuteMotion.action'
...
class TestExecuteMotionActionContract(unittest.TestCase):
    """防止 motion goal/result/feedback 接口发生未审查漂移。"""
    ...
    def test_status_values_and_build_registration_are_frozen(self):
        ...
        self.assertIn('"action/ExecuteMotion.action"', cmake_source)
